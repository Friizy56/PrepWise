...
4. Set public directory to `dist` and enable single-page app rewrites.
...
- The LeetCode stats integration uses an external LeetCode profile API.
- Build and deployment assume that `npm run build` succeeds and the `dist/` directory is available.
- Customize the study planner or analytics logic in `src/utils/scheduler.js` and `src/utils/analytics.js`.

## License

This project is provided as-is. Modify and extend it for your coding prep workflow.
